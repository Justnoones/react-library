...
export default function Navbar() {
    ...
    return (
        <nav onClick={changeTheme} className={`border border-b-1 ${theme == "light" ? "bg-blue-500" : "bg-gray-500"}`}>
            <ul className='flex justify-between p-3 items-center max-w-6xl mx-auto'>
                <li className='flex items-center gap-3'>
                    ...
                    <form onSubmit={searchValueHandler}>
                        <input value={search} onChange={e => setSearch(e.target.value)} type='text' name='q' placeholder='search books..' className='outline-none bg-inherit' autoComplete='off' />
                    </form>
